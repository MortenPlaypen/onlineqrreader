...
Decoder.correctErrors=function( codewordBytes,  numDataCodewords)
{
	...
	try
	{
		Decoder.rsDecoder.decode(codewordsInts, numECCodewords); //THIS ONE
...
Decoder.decode=function(bits)
{
	...
	for (var j = 0; j < dataBlocks.length; j++)
	{
		...
		//Decoder.correctErrors(codewordBytes, numDataCodewords); //THIS ONE
		for (var i = 0; i < numDataCodewords; i++)
		{
...
qrcode.process = function(ctx){
	...
	console.log(qRCodeMatrix.bits);
	var reader = Decoder.decode(qRCodeMatrix.bits); //THIS ONE
